...
public class ActivityLogin extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		((ImageButton)findViewById(R.id.imageButtonFindPwd)).setOnClickListener(lsrButton);
...
//				
			case R.id.buttonRegister:
				...
				strPassword = pwd;
				*/
				startActivityForResult(new Intent(context, ActivityRegister.class), 0);
				break;
			case R.id.imageButtonFindPwd:
				/*
				account = etAccount.getText().toString();
				progressBar.setVisibility(View.VISIBLE);
				webApi = new WebApi(context);
				...
				*/
				startActivityForResult(new Intent(context, ActivityResetPwd.class), 0);
				break;
			}
		}
		...
		public void doHttpResponse(String response) {
			...
			if (WebApi.isRespSuccess(response)){
				...
				*/
				...
				msg.what = ActivityLogin.HANDLER_MSG_TOAST;
